...
const aboutText = [
  ...
  p([`Я живу в `, a({ href : ufaLink, target: '_blank' }, 'Уфе'), `. Есть такой город в России. У меня нет машины, я работаю дома и в кафе, сплю на полу, и меня устраивает такой образ жизни.`]),
  p(`
