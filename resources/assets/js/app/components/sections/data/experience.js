...
const experienceText = [
  ...
  h1('Настоящее время'),
  p([`
    В данный моент я являюсь техническим руководителем международного проекта `,a({ href: 'https://ru.quranacademy.org/profile', target:'_blank' }, 'Академия Корана'),`. Данный проект мы пишем на основе фреймворка Laravel, а на стороне фронтенда трудятся JSPM и Riot.js. Проект также является мультиязычным.
    В данный момент я работаю здесь уже ${academyAge}.
  `]),
]
